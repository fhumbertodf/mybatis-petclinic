...
class OrderMapperTest {
  ...
  private OrderMapper mapper;
	...
	public OrderMapperTest() {
		...
		mapper = container.select(OrderMapper.class).get();
  ...
  void insertOrder() {
    ...
    // then
    Map<String, Object> record = sqlSession.selectOne("org.mybatis.jpetstore.mapper.OrderMapper.dynamicQuery", "SELECT * FROM orders WHERE orderid = 1");
  ...
  void insertOrderStatus() {
    ...
    // then
    Map<String, Object> record = sqlSession.selectOne("org.mybatis.jpetstore.mapper.OrderMapper.dynamicQuery", "SELECT * FROM orderstatus WHERE orderid = 1");
  ...
  void getOrdersByUsername() {
    ...
    // when
    List<Order> orders = mapper.getOrdersByUsername("cdi");
