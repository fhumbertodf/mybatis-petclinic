...
public class AccountMapperTest {
	...
	public AccountMapperTest() {
		...
		mapper = container.select(AccountMapper.class).get();
	...
	void insertAccount() {
		...
		// then
		Map<String, Object> record = sqlSession.selectOne("org.mybatis.jpetstore.mapper.AccountMapper.dynamicQuery", "SELECT * FROM account WHERE userid = 'mybatis'");
	...
	void insertProfile() {
		...
		// then
		Map<String, Object> record = sqlSession.selectOne("org.mybatis.jpetstore.mapper.AccountMapper.dynamicQuery", "SELECT * FROM profile WHERE userid = 'mybatis'");
	...
	void insertSignon() {
		...
		// then
		Map<String, Object> record = sqlSession.selectOne("org.mybatis.jpetstore.mapper.AccountMapper.dynamicQuery", "SELECT * FROM signon WHERE username = 'mybatis'");
	...
	void updateAccount() {
		...
		// then
		Map<String, Object> record = sqlSession.selectOne("org.mybatis.jpetstore.mapper.AccountMapper.dynamicQuery", "SELECT * FROM account WHERE userid = 'j2ee'");
	...
	void updateProfile() {
		...
		// then
		Map<String, Object> record = sqlSession.selectOne("org.mybatis.jpetstore.mapper.AccountMapper.dynamicQuery", "SELECT * FROM profile WHERE userid = 'j2ee'");
	...
	void updateSignon() {
		...
		// then
		Map<String, Object> record = sqlSession.selectOne("org.mybatis.jpetstore.mapper.AccountMapper.dynamicQuery", "SELECT * FROM signon WHERE username = 'j2ee'");
